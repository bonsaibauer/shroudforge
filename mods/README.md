...
| No Resource Cost | Pregame | Client and server | Sets selected recipe input and resource costs to zero | Item, energy, and water controls |
...
| Unlock Blueprints | Pregame | Client and server | Replaces supported recipe knowledge requirements | Lifecycle information and restart notice |
