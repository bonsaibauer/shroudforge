...
use super::{ImpactAssembler, ImpactNode, ImpactOps, ImpactProgram, ImpactProgramData, ParseError};

impl ImpactAssembler<'_> {
    pub fn parse_text(
        &self,
        data: &ImpactProgramData,
        code: &str,
    ) -> Result<Vec<ImpactOps>, ParseError> {
    ...
    pub fn write_text<W: Write>(
        ...
        for instruction in code {
            ...
            match instruction {
                ...
                ImpactOps::Call(unk, hash) | ImpactOps::ECall(unk, hash) => {
