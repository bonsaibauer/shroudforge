...
pub fn generate(type_registry: &TypeRegistry) -> String {
        ...
        match r#type.primitive_type {
            ...
            PrimitiveType::Struct => {
                ...
                for field in r#type.struct_fields.values() {
                    ...
                    append_type_name(
                        &mut output,
                        type_registry.get(field.r#type).unwrap(),
                        type_registry,
                    );
                    output.push('\n');
                }
...
fn append_type_name(output: &mut String, r#type: &TypeMetadata, type_registry: &TypeRegistry) {
    match r#type.primitive_type {
...
fn append_qualified_name(output: &mut String, qualified_name: &str) {
